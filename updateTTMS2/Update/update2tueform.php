...
?>
<?php
 $qr = "select * from tuett where id = 1";
 include ('../dbcon.php');
...
<h4><a href="up2tue.php" style="float:left;font-size:20px;color:black;"><-Back</a>
<h1 align="center" style="font-size:40;">Update Tuesday Classes Time Table</h1>
</h4>
<br>
<br>
<br>
